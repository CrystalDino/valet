...
//BACKGROUND CHANGER
  ...
  $(function() {
      $("#button-bg").click(function() {
          $("body").css({
              "background": "url('/public/img/bg5.jpg')no-repeat center center fixed"
          });
      });
      ...
      $("#button-bg5").click(function() {
          $("body").css({
              "background": "url('/public/img/giftly.png')repeat"
          });
      ...
      $("#button-bg7").click(function() {
          $("body").css({
              "background": "url('/public/img/bg3.png')repeat"
          });

      });
      $("#button-bg8").click(function() {
          $("body").css({
              "background": "url('/public/img/bg8.jpg')no-repeat center center fixed"
          });
      });
      $("#button-bg9").click(function() {
          $("body").css({
              "background": "url('/public/img/bg9.jpg')no-repeat center center fixed"
          });
      });

      $("#button-bg10").click(function() {
          $("body").css({
              "background": "url('/public/img/bg10.jpg')no-repeat center center fixed"
          });
      });
      $("#button-bg11").click(function() {
          $("body").css({
              "background": "url('/public/img/bg11.jpg')no-repeat center center fixed"
          });
      });
      $("#button-bg12").click(function() {
          $("body").css({
              "background": "url('/public/img/bg12.jpg')no-repeat center center fixed"
          });
      });

      $("#button-bg13").click(function() {
          $("body").css({
              "background": "url('/public/img/bg13.jpg')repeat"
          });
